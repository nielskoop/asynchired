        ...
        {() => (
          <>
            <Listbox.Button className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
              ...
              <span className="absolute inset-y-0 right-0 flex items-center border-l-2 ">
                <button
            ...
            >
              <Listbox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
                {searches!.length === 0 ? (
                  <Listbox.Option
                    value="Save a search first!"
                    className={
                      "block truncate pl-3 pr-10 text-sm leading-5  text-gray-500"
                    }
                    disabled={true}
                  >
                    Save a search first!
