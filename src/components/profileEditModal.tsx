...
export const ProfileEditModal: React.FC = () => {
  ...
  profileDetails.userId === '' ? setProfileDetails({ ...profileData, userId: userId }) : null
    ...
    <>
      ...
      >
        <Dialog.Panel>
          ...
          >
            <h3 className="w-1/2 pl-1"> Use the edit icons to update your account details below.</h3>
