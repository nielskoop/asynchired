...
export const UserJobsTracker: React.FC = () => {
  ...
  return (
    <div className=" relative mb-8 flex h-[400px] w-[400px] flex-col rounded-lg border-2 border-solid border-[#1A78E6] shadow-lg sm:w-[550px] md:w-[600px]">
      <ul className="flex flex-row justify-evenly border-b-2 border-[#1A78E6] py-2 text-lg">
        <li>
          <button
